KManager.action :bootstrap do
  action do
    application_name = :calculator_pure_css_html
    ...
    director = KDirector::Dsls::BasicDsl
      ...
      .data(
        ...
        application_description:    'NoJS - Creating a Calculator with only pure HTML and CSS.',
        author:                     'David Cruwys',
...
KManager.opts.app_name                    = 'calculator-pure-css-html'
